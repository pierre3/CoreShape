...
namespace CoreShape
{
    ...
    public record struct Color
    {
        ...
        public static readonly Color DarkGrey = new Color(169, 169, 169);
        ...
        public static readonly Color DimGrey = new Color(105, 105, 105);
        public static readonly Color LightSlateGray = new Color(119, 136, 153);
        public static readonly Color LightSlateGrey = new Color(119, 136, 153);
        public static readonly Color SlateGray = new Color(112, 128, 144);
        public static readonly Color SlateGrey = new Color(112, 128, 144);
